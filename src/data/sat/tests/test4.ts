...
const module1: SatTestQuestion[] = [
  ...
  },
  {
    ...
    explanation: ['Set the rule equal to the output: $5 - 3x = -7$.', 'Subtract $5$: $-3x = -12$.', '$x = 4$.'],
  ...
  },
  {
    ...
    explanation: ['Expand the left: $6x - 2c$.', 'Infinitely many solutions requires the two sides to be identical, so $-2c = 10$.', '$c = -5$.'],
  ...
  },
  {
    ...
    answerType: 'numeric', answer: '28900',
  ...
  },
  {
    ...
    explanation: ['One real solution means the discriminant is zero: $100 - 4c = 0$.', '$c = 25$.', 'Check: $x^2 - 10x + 25 = (x - 5)^2$, with the single root $x = 5$ ✓'],
...
const module2: SatTestQuestion[] = [
  ...
  },
  {
    ...
    explanation: ['Substitute $(0, -21)$: $-21 = a(1)(-7) = -7a$.', '$a = 3$.', 'The parabola is $y = 3(x + 1)(x - 7)$.'],
  ...
  },
  {
    ...
    answerType: 'numeric', answer: '48',
    explanation: ['The exponent is $\\dfrac{4}{2} = 2$.', '$4^2 = 16$.', '$f(4) = 3 \\times 16 = 48$.'],
