...
export const GENIUS_TIPS: GeniusTip[] = [
  ...
  { text: '“5 less than twice n” is 2n − 5, never 5 − 2n. The phrase reads backwards on purpose.', domain: 'A1' },
  { text: 'Move the SMALLER x-team across the equals sign — the x-term stays positive and sign slips vanish.', domain: 'A1' },
  { text: 'The inequality flips ONLY when you multiply or divide by a negative. Adding a negative changes nothing.', domain: 'A1' },
  { text: 'Test an inequality answer with x = 0: five seconds, and a missing flip has nowhere to hide.', domain: 'A1' },
  { text: 'f(3) is not “f times 3” — the parentheses are the machine\'s mouth, and 3 is the snack you feed it.', domain: 'A1' },
  { text: 'To undo a two-step machine, walk backwards: last operation first. Out of socks-then-shoes comes shoes-then-socks.', domain: 'A1' },
  { text: 'Slope shortcut: same y-values means slope 0 (flat road); same x-values means undefined (a wall).', domain: 'A1' },
  { text: 'In y = mx + b, b happens ONCE (the starting amount) and m happens EVERY step. Ask each number which it is.', domain: 'A1' },
  { text: 'Check a system\'s answer in BOTH equations — one equation happy is only half a solution.', domain: 'A1' },
  { text: 'Exponent rules only fire on the SAME base: x³ · x² = x⁵, but x³ · y² refuses to merge.', domain: 'A1' },
  { text: 'Constant differences in a table = linear. Constant RATIOS = exponential. One subtraction, one division, done.', domain: 'A1' },
  { text: '(x + 5)² = x² + 10x + 25 — three terms. The middle one is the piece everyone forgets.', domain: 'A1' },
  { text: 'After factoring, multiply back. If it does not rebuild the original exactly, the factoring is wrong.', domain: 'A1' },
  { text: 'A parabola\'s vertex sits exactly halfway between its two x-intercepts — symmetry does the work for you.', domain: 'A1' },
  // Precalculus
