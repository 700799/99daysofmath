...
class Lesson6G5Examples(ExamplesDeck):
    ...
    EXAMPLES = [
        ("An L-shape = a 4x2 rectangle plus a 3x2 rectangle. Total area?", ["4x2 = 8.", "3x2 = 6.", "8 + 6 = 14."], "14"),
        ("A 5x5 square with a 2x2 square cut out. Area left?", ["25 - 4.", "= 21."], "21"),
        ("A 6x3 rectangle with a triangle (base 6, height 2) on top. Area?", ["Rectangle = 18.", "Triangle = ?-6-2 = 6.", "18 + 6 = 24."], "24"),
    ]
