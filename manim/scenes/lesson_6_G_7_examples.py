...
class Lesson6G7Examples(ExamplesDeck):
    ...
    DOMAIN = "6.G"
    EXAMPLES = [
        ("Two rectangles side-by-side: 4 × 3 and 4 × 2. Total area?", ["Piece 1: 4 × 3 = 12.", "Piece 2: 4 × 2 = 8.", "Total: 20."], "20"),
        ("A 6 × 5 rectangle with a 2 × 2 square cut out. Area left?", ["Big: 6 × 5 = 30.", "Cutout: 2 × 2 = 4.", "Left: 30 − 4 = 26."], "26"),
        ("A \"house\": rectangle 8 × 5 plus triangle base 8, height 4 on top.", ["Rectangle: 8 × 5 = 40.", "Triangle: ½ × 8 × 4 = 16.", "Total: 56."], "56"),
    ]
