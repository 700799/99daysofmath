...
class Lesson6G1(Scene):
    def construct(self):
        ...
        self.play(FadeIn(rect_label, shift=DOWN * 0.2))
        ...
        self.play(Create(rect), Write(w_lbl), Write(h_lbl))
        self.wait(0.3)
        ...
        self.play(FadeIn(tri_label, shift=DOWN * 0.2))
        ...
        self.play(Create(tri), Write(base_lbl))
        self.play(Create(height_line), Create(right_angle), Write(height_lbl))
        self.wait(0.3)
